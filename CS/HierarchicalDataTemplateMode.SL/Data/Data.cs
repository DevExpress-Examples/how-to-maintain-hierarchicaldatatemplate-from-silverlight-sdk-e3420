    ...
    public class States : List<State> {
        ...
        public static List<State> DataSource {
            get {
                if (src == null) {
                    src = new List<State>();
                    src.Add(new State() { TextValue = "Not started", StateValue = 0, Image = new BitmapImage(new Uri("/HierarchicalDataTemplateMode.SL;component/Images/State_NotStarted.png", UriKind.Relative)) });
                    src.Add(new State() { TextValue = "In progress", StateValue = 1, Image = new BitmapImage(new Uri("/HierarchicalDataTemplateMode.SL;component/Images/State_InProgress.png", UriKind.Relative)) });
                    src.Add(new State() { TextValue = "Completed", StateValue = 2, Image = new BitmapImage(new Uri("/HierarchicalDataTemplateMode.SL;component/Images/State_Completed.png", UriKind.Relative)) });
                }
                return src;
            }
        }
